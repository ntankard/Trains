...
package Train_state_def is
  ...
  type Train_state is record
      ...
      User_input_buffer : Buffers.Command_Buffer;  --a buffer of commands to deal with later
   end record;

   Train_state_array:array(Raildefs.Train_Id) of Train_state;
